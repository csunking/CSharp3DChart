...
namespace Scatter
{
    static class Projection
    {
        ...
        /// |--------------------------->x
        /// </summary>
        /// <param name="x">3d 点list</param>
        /// <param name="s_x">画布的宽</param>
        /// <param name="s_y">画布的高</param>
        /// <param name="f"></param>
        /// <param name="d_w">相机的位置</param>
        /// <param name="azimuth">方位角</param>
        /// <param name="elevation">高度角</param>
        /// <returns></returns>
        static public PointF[] ProjectVector(List<double[]> x, double s_x, double s_y, double f, 
            double[] d_w, double azimuth, double elevation)
        {
            PointF[] Pvec;
            Algerbra.Matrix<double> Mext = GetMext(azimuth, elevation, d_w);
            Algerbra.Matrix<double> Mint = GetMint(s_x, s_y, f);
        ...
        {
            Algerbra.Matrix<double> Mint;

            Mint = new Algerbra.Matrix<double>(3, 3);
            double o_x = s_x / 2;
            double o_y = s_y / 2;
            double a = 1;
